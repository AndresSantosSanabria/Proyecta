...
WHERE r.codigo IN ('admin', 'gestor_tic')
  AND p.codigo IN ('DASHBOARD:VER', 'PROYECTO:VER', 'PROYECTO:CREAR', 'PROYECTO:EDITAR', 'PROYECTO:CERRAR',
                   ...
                   'ENTREGABLE:APROBAR', 'AVANCE:VER', 'AVANCE:EDITAR', 'AVANCE:APROBAR',
                   'EVIDENCIA:CARGAR', 'DOCUMENTO:CARGAR',
                   'CRONOGRAMA:CARGAR', 'CIERRE:SOLICITAR', 'CIERRE:APROBAR', 'SISTEMA:CONFIGURAR')
...
JOIN proyecta_db.permisos p ON p.codigo IN ('DASHBOARD:VER', 'PROYECTO:VER', 'REPORTE:VER', 'ANALITICA:VER',
                                             'ENTREGABLE:APROBAR', 'AVANCE:VER', 'AVANCE:EDITAR',
                                             'EVIDENCIA:CARGAR', 'DOCUMENTO:CARGAR',
                                             'CRONOGRAMA:CARGAR', 'CIERRE:SOLICITAR')
