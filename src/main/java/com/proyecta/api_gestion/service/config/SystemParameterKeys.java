...
public final class SystemParameterKeys {
    ...
    public static final String DASHBOARD_VENTANA_VENCIMIENTO_DIAS = "ventana_vencimiento_dias";
    public static final String DASHBOARD_MAX_PROYECTOS_ACTIVOS = "max_proyectos_activos";
