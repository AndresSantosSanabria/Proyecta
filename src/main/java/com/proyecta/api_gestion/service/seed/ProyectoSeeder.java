...
public class ProyectoSeeder {
    ...
    private void agregarRiesgosMasivos(Proyecto proyecto) {
        ...
        riesgos.add(crearRiesgo(proyecto, "R01", "Sobrecarga de demanda sobre la mesa de ayuda", "Operativo", "Alta rotación de solicitudes en temporadas de corte", "Aumento de tiempos de respuesta y saturación del equipo de soporte", Probabilidad.CUATRO, Impacto.TRES, Probabilidad.TRES, Impacto.TRES, "Priorización por criticidad, colas de atención y refuerzo temporal de soporte", "Preventivo", "Alta", "Escalar a mesa de nivel 2 y redistribuir tickets por criticidad", "Dirección TIC", "Coordinador de Soporte", LocalDate.now().plusDays(15), "Indicador: tiempo promedio de respuesta", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R02", "Desalineación entre alcance y necesidades reales", "Funcional", "Cambios frecuentes en requisitos durante la ejecución", "Reprocesos, incremento de alcance y retrasos acumulados", Probabilidad.CUATRO, Impacto.CUATRO, Probabilidad.TRES, Impacto.CUATRO, "Control de cambios con comité y actas de validación", "Preventivo", "Alta", "Registrar cambios en comité y ajustar backlog", "Oficina de Planeación TIC", "Analista Funcional", LocalDate.now().plusDays(20), "Indicador: número de cambios aprobados", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R03", "Fallas en autenticación o permisos", "Tecnológico", "Configuración incompleta de roles o expiración de credenciales", "Bloqueo de usuarios y detención de procesos críticos", Probabilidad.TRES, Impacto.CUATRO, Probabilidad.DOS, Impacto.TRES, "Monitoreo de logs, pruebas de acceso y respaldo de cuentas críticas", "Correctivo", "Alta", "Rotar credenciales y validar permisos por ambiente", "Seguridad de la Información", "Administrador de Seguridad", LocalDate.now().plusDays(12), "Indicador: accesos fallidos por hora", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R04", "Pérdida de integridad de datos", "Datos", "Errores de sincronización o validaciones incompletas", "Información inconsistente en reportes y trazabilidad", Probabilidad.TRES, Impacto.CUATRO, Probabilidad.DOS, Impacto.TRES, "Backups automáticos, validaciones de negocio y auditoría", "Preventivo", "Alta", "Ejecutar conciliación diaria y revisión de logs", "Gestión de Datos", "Arquitecto de Datos", LocalDate.now().plusDays(18), "Indicador: inconsistencias detectadas", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R05", "Retraso en entregas críticas de desarrollo", "Cronograma", "Dependencias técnicas y disponibilidad parcial del equipo", "Atraso de hitos y compresión de pruebas", Probabilidad.TRES, Impacto.TRES, Probabilidad.TRES, Impacto.DOS, "Plan de iteraciones, seguimiento semanal y tablero Kanban", "Preventivo", "Media", "Reasignar tareas y bloquear alcance no prioritario", "PMO TIC", "Líder de Proyecto", LocalDate.now().plusDays(10), "Indicador: tareas vencidas", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R06", "Caídas en ambientes de prueba", "Infraestructura", "Recursos limitados y pruebas concurrentes", "Interrupción de validaciones y pérdida de productividad", Probabilidad.TRES, Impacto.TRES, Probabilidad.DOS, Impacto.DOS, "Ventanas de prueba, monitoreo y recursos reservados", "Correctivo", "Media", "Reiniciar ambientes y validar estabilidad previa", "Infraestructura TIC", "Administrador de Ambientes", LocalDate.now().plusDays(14), "Indicador: disponibilidad de ambientes", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R07", "Rechazo del usuario final", "Adopción", "Pantallas poco familiares o capacitación insuficiente", "Baja utilización de la solución y regreso a procesos manuales", Probabilidad.TRES, Impacto.CUATRO, Probabilidad.DOS, Impacto.TRES, "Capacitación, acompañamiento y mejora UX iterativa", "Preventivo", "Alta", "Ajustar interfaz y reforzar formación", "Gestión del Cambio", "Líder de Adopción", LocalDate.now().plusDays(25), "Indicador: usuarios capacitados vs usuarios activos", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R08", "Desfase de fechas de entregables", "Cronograma", "Dependencias externas y validaciones tardías", "Atrasos acumulados y reprogramación de fases", Probabilidad.CUATRO, Impacto.TRES, Probabilidad.TRES, Impacto.TRES, "Alertas tempranas y revisión de hitos semanales", "Preventivo", "Alta", "Escalar alertas y ajustar secuencias", "PMO TIC", "Gestor del Cronograma", LocalDate.now().plusDays(9), "Indicador: entregables vencidos", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R09", "Documentación incompleta", "Documental", "Falta de estandarización al registrar evidencias", "Dificultad para auditoría y cierre técnico", Probabilidad.TRES, Impacto.TRES, Probabilidad.DOS, Impacto.DOS, "Checklist documental y revisión de calidad", "Preventivo", "Media", "Completar evidencias faltantes antes de cierre", "Gestión Documental", "Analista Documental", LocalDate.now().plusDays(17), "Indicador: documentos pendientes", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R10", "Integración inestable con servicios externos", "Integración", "Cambios en contratos o latencia en APIs", "Errores intermitentes y reintentos fallidos", Probabilidad.TRES, Impacto.CUATRO, Probabilidad.DOS, Impacto.TRES, "Versionamiento de contratos y pruebas contractuales", "Preventivo", "Alta", "Ajustar timeouts y manejar fallback", "Arquitectura de Integración", "Líder Técnico", LocalDate.now().plusDays(13), "Indicador: porcentaje de fallos de integración", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R11", "Sobrecarga de reportes al corte", "Desempeño", "Consultas complejas sobre grandes volúmenes de datos", "Lentitud en tableros y reportes institucionales", Probabilidad.TRES, Impacto.TRES, Probabilidad.DOS, Impacto.DOS, "Índices de BD y caché de consultas", "Preventivo", "Media", "Optimizar consultas y programar generación nocturna", "Desarrollo", "Ingeniero Backend", LocalDate.now().plusDays(11), "Indicador: tiempo de generación de reportes", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R12", "Fuga de documentos sensibles", "Seguridad", "Permisos mal configurados o enlaces expuestos", "Exposición de información confidencial", Probabilidad.DOS, Impacto.CUATRO, Probabilidad.DOS, Impacto.TRES, "Acceso por rol, auditoría y trazabilidad", "Preventivo", "Alta", "Revisar permisos y revocar accesos no autorizados", "Seguridad de la Información", "Oficial de Seguridad", LocalDate.now().plusDays(7), "Indicador: accesos inusuales", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R13", "Dependencia de una sola persona clave", "Gestión del talento", "Conocimiento concentrado en un miembro del equipo", "Riesgo de paro parcial ante ausencia", Probabilidad.TRES, Impacto.TRES, Probabilidad.DOS, Impacto.DOS, "Documentación técnica y pareamiento", "Preventivo", "Media", "Asignar suplente y transferir conocimiento", "PMO TIC", "Líder Funcional", LocalDate.now().plusDays(30), "Indicador: dependencia crítica", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R14", "Errores de configuración en ambientes", "Técnico", "Parámetros distintos entre desarrollo, pruebas y producción", "Comportamientos inconsistentes y fallos de despliegue", Probabilidad.TRES, Impacto.CUATRO, Probabilidad.DOS, Impacto.TRES, "Plantillas de configuración y revisión por pares", "Preventivo", "Alta", "Homologar variables de entorno", "DevOps", "Ingeniero DevOps", LocalDate.now().plusDays(16), "Indicador: incidencias por despliegue", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R15", "Cambio normativo o de lineamientos", "Normativo", "Nuevas directrices institucionales o regulatorias", "Reajuste de alcance, validaciones y tiempos", Probabilidad.DOS, Impacto.CUATRO, Probabilidad.DOS, Impacto.TRES, "Seguimiento jurídico y revisión periódica", "Preventivo", "Media", "Ajustar el diseño a la nueva directriz", "Asesoría Jurídica", "Abogado TIC", LocalDate.now().plusDays(45), "Indicador: cambios regulatorios", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R16", "Baja calidad en datos de entrada", "Datos", "Cargas manuales con información incompleta o duplicada", "Resultados erróneos y reprocesos", Probabilidad.TRES, Impacto.TRES, Probabilidad.DOS, Impacto.DOS, "Validaciones de formato y catálogos maestros", "Preventivo", "Media", "Depurar datos y bloquear entradas inválidas", "Gestión de Datos", "Analista de Calidad", LocalDate.now().plusDays(21), "Indicador: registros rechazados", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R17", "Pérdida de evidencias de avance", "Control interno", "Carga incorrecta o borrado accidental de archivos", "Dificultad para demostrar cumplimiento", Probabilidad.TRES, Impacto.CUATRO, Probabilidad.DOS, Impacto.TRES, "Repositorio central y respaldo automático", "Preventivo", "Alta", "Restaurar evidencias desde backup", "Control Interno", "Gestor de Evidencias", LocalDate.now().plusDays(8), "Indicador: evidencias faltantes", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R18", "Atraso en aprobaciones internas", "Gobernanza", "Tiempos de revisión superiores a lo previsto", "Bloqueo de hitos y dependencia del comité", Probabilidad.CUATRO, Impacto.TRES, Probabilidad.TRES, Impacto.DOS, "Agenda de comité y tiempos máximos de respuesta", "Preventivo", "Media", "Escalar aprobaciones pendientes", "Comité TIC", "Secretaría Técnica", LocalDate.now().plusDays(6), "Indicador: aprobaciones pendientes", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R19", "Sobrecarga de soporte post-implementación", "Operación", "Alta demanda inicial tras la salida a producción", "Retrasos en atención y percepción negativa del usuario", Probabilidad.TRES, Impacto.TRES, Probabilidad.DOS, Impacto.DOS, "Plan de estabilización y mesa de ayuda reforzada", "Correctivo", "Media", "Ampliar cobertura temporal de soporte", "Soporte TIC", "Coordinador de Soporte", LocalDate.now().plusDays(18), "Indicador: tickets abiertos", EstadoRiesgo.PENDIENTE));
        riesgos.add(crearRiesgo(proyecto, "R20", "Inconsistencias entre avance físico y avance reportado", "Seguimiento", "Registro tardío de entregables o evidencia mal cargada", "Desfase entre la realidad del proyecto y el semáforo", Probabilidad.TRES, Impacto.CUATRO, Probabilidad.DOS, Impacto.TRES, "Validación semanal de evidencias y corte operativo", "Preventivo", "Alta", "Cruzar evidencia con avance y corregir el reporte", "PMO TIC", "Analista de Seguimiento", LocalDate.now().plusDays(5), "Indicador: diferencias entre reporte y ejecución", EstadoRiesgo.PENDIENTE));
    ...
    private NivelRiesgo calcularNivel(Probabilidad probabilidad, Impacto impacto) {
        ...
        int score = p + i;
        if (score >= 2 && score <= 4) return NivelRiesgo.BAJO;
        if (score >= 5 && score <= 6) return NivelRiesgo.MODERADO;
        if (score >= 7 && score <= 8) return NivelRiesgo.ALTO;
