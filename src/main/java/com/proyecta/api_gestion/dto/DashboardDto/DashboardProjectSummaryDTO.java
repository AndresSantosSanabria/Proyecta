...
public class DashboardProjectSummaryDTO {
	 ...
	 @Schema(description = "Contador de la cantidad de entregables atrazados en el proyecto", example = "2")
	    private Integer entregablesAtrasados;
	 
	 public DashboardProjectSummaryDTO(){}

	 public DashboardProjectSummaryDTO(String codigo, String nombreProyecto, String nombreDependencia, Integer avance,
			String estado, Integer entregablesAtrasados) {
		super();
		this.codigo = codigo;
	 ...
	 public int getEntregablesAtrasados() {
		 return entregablesAtrasados;
	 }

	 public void setEntregablesAtrasados(Integer entregablesAtrasados) {
		 this.entregablesAtrasados = entregablesAtrasados;
	 }
