...
public class DashboardSummaryDTO {
    ...
    @Schema(description = "Tendencia actual del avance (positiva, negativa, estable)", example = "positiva", allowableValues = {"positiva", "negativa", "estable"})
    ...
    public DashboardSummaryDTO(Long total_proyectos, Long activos, Long cerrados, Integer avance_promedio, String avance_tendencia, Long entregables_atrasados, Long proximos_a_vencer, Integer dias_ventana_vencimiento) {
    ...
    public Long getTotal_proyectos() {
        return total_proyectos;
    }

    public void setTotal_proyectos(Long total_proyectos) {
        this.total_proyectos = total_proyectos;
    }
    ...
    public Integer getAvance_promedio() {
        return avance_promedio;
    }

    public void setAvance_promedio(Integer avance_promedio) {
        this.avance_promedio = avance_promedio;
    }

    public String getAvance_tendencia() {
        return avance_tendencia;
    }

    public void setAvance_tendencia(String avance_tendencia) {
        this.avance_tendencia = avance_tendencia;
    }

    public Long getEntregables_atrasados() {
        return entregables_atrasados;
    }

    public void setEntregables_atrasados(Long entregables_atrasados) {
        this.entregables_atrasados = entregables_atrasados;
    }

    public Long getProximos_a_vencer() {
        return proximos_a_vencer;
    }

    public void setProximos_a_vencer(Long proximos_a_vencer) {
        this.proximos_a_vencer = proximos_a_vencer;
    }

    public Integer getDias_ventana_vencimiento() {
        return dias_ventana_vencimiento;
    }

    public void setDias_ventana_vencimiento(Integer dias_ventana_vencimiento) {
        this.dias_ventana_vencimiento = dias_ventana_vencimiento;
    }
}
